clear;
%Example demonstration of the hybrid initialization (random & NNDSVD initialization) for disjoint community detection
...
for l=1:num_params
    ...
    fid = fopen('DHCD_T-A(dis_hyd).txt', 'at');
    ...
    fid = fopen('DHCD_A-T(dis_hyd).txt', 'at');
